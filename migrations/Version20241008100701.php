 ...
 */
final class Version20241008100701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chapters (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, description LONGTEXT DEFAULT NULL, validated TINYINT(1) NOT NULL, cours_id INT DEFAULT NULL, INDEX IDX_C72143717ECF78B0 (cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, level VARCHAR(255) NOT NULL, estimated_time TIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, files VARCHAR(255) DEFAULT NULL, validated TINYINT(1) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, img_url VARCHAR(255) DEFAULT NULL, language_id INT NOT NULL, INDEX IDX_FDCA8C9C82F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, content VARCHAR(255) NOT NULL, rating INT NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, language_id INT NOT NULL, cours_id INT NOT NULL, INDEX IDX_794381C6A76ED395 (user_id), INDEX IDX_794381C682F1BAF4 (language_id), INDEX IDX_794381C67ECF78B0 (cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
