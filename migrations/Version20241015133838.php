 ...
 */
final class Version20241015133838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD quote VARCHAR(255) NOT NULL, ADD emploi VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP quote, DROP emploi');
    }
}
